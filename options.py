...
class Options():
    ...
    def initialize(self):
        ...
        parser.add_argument('--av_size', type=int, default=2, help="set 0 if you do not need attr_vec")
        ...
        parser.add_argument('--d_size', type=int, default=4, help="d vector")
        parser.add_argument('--gc_size', type=int, default=32, help="gc vector")
